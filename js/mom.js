...
momObj.prototype = {
	...
	draw: function() {
		...
		{
			ctx1.drawImage(bigBodyOrg[bigBodyCount], -bigBodyOrg[bigBodyCount].width * 0.5, -bigBodyOrg[
				bigBodyCount].height * 0.5);
		} else {
			ctx1.drawImage(bigBodyBlu[bigBodyCount], -bigBodyBlu[bigBodyCount].width * 0.5, -bigBodyBlu[
				bigBodyCount].height * 0.5);
		}

		var bigEyeCount = this.bigEyeCount;
		ctx1.drawImage(bigEye[bigEyeCount], -bigEye[bigEyeCount].width * 0.5, -bigEye[bigEyeCount].height *
		0.5);

		var bigTailCount = this.bigTailCount;
		ctx1.drawImage(bigTail[bigTailCount], -bigTail[bigTailCount].width * 0.5 + 30, -bigTail[bigTailCount]
			.height * 0.5);
		ctx1.restore();
	}
};
